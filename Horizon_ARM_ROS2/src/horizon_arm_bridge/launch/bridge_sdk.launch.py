...
def generate_launch_description():
    ...
    ui_cmd = (
        'export PYTHONPATH=$HOME/Horizon_ARM_ROS2/Control_SDK-ros:$PYTHONPATH && '
        'source ~/Horizon_ARM_ROS2/install/setup.bash && '
        'python3 ~/Horizon_ARM_ROS2/arm-ros2/review_ui.py --mapping ~/Horizon_ARM_ROS2/arm-ros2/mapping.yaml'
    )
